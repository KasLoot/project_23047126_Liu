...
def visualize_augmented_samples(
    ...
    Expects `root_dir` to be compatible with `HandGestureDataset` (i.e. contains
    ...
    dataset = HandGestureDataset_test(root_dir=root_dir, transform=SegAugment_test(out_size=out_size))
    if len(dataset) == 0:
