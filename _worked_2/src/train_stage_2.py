...
from dataloader import HandGestureDataset_test, SegAugment_test
...
def build_model_and_profile_gpu_usage(device: torch.device) -> YOLO26MultiTask:
    ...
    if device.type != "cuda":
        ...
        model = YOLO26MultiTask(yolo_weights_path="outputs/stage_1/train_2/best.pt", num_classes=10).to(device)
    ...
    check_point = torch.load(checkpoint_path, map_location="cpu")["model"]
